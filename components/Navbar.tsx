    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-4 md:gap-6 text-xs font-medium tracking-widest text-foreground/70">
          <a href="#work" onClick={(e) => handleScrollTo(e, "#work")} className="hover:text-foreground transition-colors duration-300 hidden md:block cursor-pointer">
            {t("nav_work")}
          </a>
          <a href="#about" onClick={(e) => handleScrollTo(e, "#about")} className="hover:text-foreground transition-colors duration-300 hidden md:block cursor-pointer">
            {t("nav_about")}
          </a>
          <a href="#contact" onClick={(e) => handleScrollTo(e, "#contact")} className="hover:text-foreground transition-colors duration-300 hidden md:block cursor-pointer">
            {t("nav_contact")}
          </a>
          ...
          <button
            onClick={toggleLang}
            className="flex items-center justify-center gap-1.5 px-2.5 py-1.5 rounded-full border border-foreground/15 hover:bg-foreground/10 transition-all text-[11px] tracking-wider text-foreground font-mono"
